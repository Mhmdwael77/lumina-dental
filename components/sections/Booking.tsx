...
export function Booking() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Frontend demo only — no backend request is made.
    setSubmitted(true);
  };
        ...
        <div className="bk-reveal">
          {submitted ? (
            <div
              ref={successRef}
              tabIndex={-1}
              className="flex min-h-[24rem] flex-col items-start justify-center rounded-2xl border border-ink/10 bg-white/50 p-10 outline-none md:p-14"
            >
              <span className="grid h-14 w-14 place-items-center rounded-full bg-gold text-ink">
